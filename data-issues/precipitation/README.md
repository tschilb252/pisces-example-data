There are two precipitation dumps occuring.    Note: There is an assosicate data set with daily values. It is easy to detect the problem when the daily data is computed.
